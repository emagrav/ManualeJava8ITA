...
public class TestCitta {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Città di mare: " + filtraCitta(listaCitta, TestCitta::isDiMare));
        listaCitta = getCitta();
        System.out.println("Città capoluogo: " + filtraCitta(listaCitta, TestCitta::isCapoluogo));
        listaCitta = getCitta();
