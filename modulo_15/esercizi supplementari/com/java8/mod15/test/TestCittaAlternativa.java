...
import com.java8.mod15.dati.Citta;
import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;
import java.util.function.Predicate;

public class TestCittaAlternativa {

    public static void main(String args[]) {
        List<Citta> listCitta = getCitta();
        System.out.println("Città di mare: " + filtraCitta(listCitta, (citta) -> citta.isDiMare()));
        listCitta = getCitta();
        System.out.println("Città capoluogo: " + filtraCitta(listCitta, (citta) -> citta.isCapoluogo()));
    }
