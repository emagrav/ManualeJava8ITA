...
import com.java8.mod13.utils.DateUtils;
...
public class TestDateUtils {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Dal primo gennaio 2010 al primo gennaio 2010 "
                + "sono passati " + intervalloInGiorni + " giorni");
        final long tempoPassatoInMinuti = DateUtils.getTempoPassato(duemila, ChronoUnit.MINUTES);
        System.out.println("Dal primo gennaio 2010 ad oggi sono passati "
                + tempoPassatoInMinuti
                + " minuti");
        LocalDateTime localDateTime = LocalDateTime.now();
        final String dataFormattata = DateUtils.formattaData(localDateTime, FORMATO_DATA);
        System.out.println("Data formattata: " + dataFormattata);
        LocalDate localDate = DateUtils.analizzaData(dataFormattata, FORMATO_DATA);
