...
public class TestPreferences {
    ...
    public TestPreferences() {
        // Istanziamo l'oggetto preferences su di un particolare "nodo" dove verranno imagazzinate le coppie chiave-valore.
        // La possibilità di poter definire diversi nodi, è una delle principali differenze che ne caratterizzano la flessibilità
